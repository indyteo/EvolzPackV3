...
execute if entity @e[tag=pg_graveModel,sort=nearest,distance=..2] run execute positioned ~ ~-2 ~ as @e[type=minecraft:armor_stand,tag=pg_graveModel,sort=nearest,limit=3] at @s run execute positioned ~ ~2 ~ run kill @s
execute if entity @e[tag=pg_graveModel,sort=nearest,distance=..2] run execute positioned ~ ~-2 ~ as @e[type=minecraft:armor_stand,tag=pg_graveModel,sort=nearest,limit=3] at @s run execute positioned ~ ~2 ~ run kill @e[type=minecraft:armor_stand,tag=pg_graveModelHead,sort=nearest,limit=1]
