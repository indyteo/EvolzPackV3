...
execute positioned ~ ~-2 ~ as @e[type=minecraft:armor_stand,tag=pg_graveModel,sort=nearest,limit=1] at @s run execute positioned ~ ~2 ~ if score @s pg_id = @p pg_id run kill @e[type=minecraft:armor_stand,tag=pg_graveModelHead,sort=nearest,limit=1]
execute positioned ~ ~-2 ~ as @e[type=minecraft:armor_stand,tag=pg_graveModel,sort=nearest,limit=3] at @s run execute positioned ~ ~2 ~ if score @s pg_id = @p pg_id run kill @s
