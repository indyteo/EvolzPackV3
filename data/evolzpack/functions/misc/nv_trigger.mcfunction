...
execute if score @s night_vision matches 1 run tellraw @s [{"text":"Night Vision : "},{"text":"Activé","color":"green"},{"text":" (Rappel : Vous devez porter un casque en Netherite dans le Nether pour bénéficier de la Night Vision)","color":"dark_gray","italic":true}]
